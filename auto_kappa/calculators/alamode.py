...
def analyze_phonon_properties(
    ...
    ###
    analyze_harmonic_properties(almcalc, calc_force, negative_freq=negative_freq, params_nac=params_nac, use_mlips=use_mlips)
...
def analyze_harmonic_with_larger_supercells(
    ...
    while isc <= max_loop:
        ...
        analyze_harmonic_properties(
                ...
                negative_freq=negative_freq, use_mlips=use_mlips)
