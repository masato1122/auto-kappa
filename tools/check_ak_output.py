...
Hot to use
==========
>>> python check_apdb_log_ver2.py --dir_apdb ${directory name}
...
def finish_harmonic(directory, tol_negative=-0.001):
...
def finish_ak_calculation(directory):
    """ Check output directory generated by auto-kappa """
    
    ### log file
    logfile = directory + "/ak.log"
    if os.path.exists(logfile) == False:
        #msg = "\n Error: ak.log does not exist."
        #print(msg)
...
def main(options):
    ...
    finish_ak_calculation(options.directory)
